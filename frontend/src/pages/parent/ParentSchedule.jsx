    ...
    try {
      ...
      parent.children.forEach(childId => {
        ...
        if (child) {
          ...
          // Create children summary
          childrenData.push({
            id: childId,
            name: `${child.firstName} ${child.lastName}`,
            age: child.age,
            classesCount: childClasses.length,
            classes: childClasses.map(cls => ({
              id: cls.id,
              name: cls.name,
              teacher: mockUsers.teachers.find(t => t.id === cls.teacherId)?.fullName || 'Teacher TBD',
      ...
      console.log('Children summary:', childrenData);
      ...
      if (childrenData.length === 1 && !selectedChildFilter) {
        setSelectedChildFilter(childrenData[0].id.toString());
      }
    } catch (error) {
