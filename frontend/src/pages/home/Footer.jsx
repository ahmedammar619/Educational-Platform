    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-400">Baraem Al-Noor</p>
              </div>
            </div>
            <p className="text-sm sm:text-base text-gray-400 mb-4 leading-relaxed">
              Nurturing young hearts with Islamic knowledge and values. 
              Comprehensive Islamic education for children of all ages.
            </p>
          ...
          {/* Services */}
          <div>
            <h4 className="text-sm sm:text-base font-semibold mb-4">Our Services</h4>
            <ul className="space-y-2 sm:space-y-3">
              <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Quran Memorization</a></li>
              <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Arabic Language</a></li>
              <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Islamic Studies</a></li>
              <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Personal Development</a></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div>
            <h4 className="text-sm sm:text-base font-semibold mb-4">Contact Info</h4>
            <div className="space-y-2 sm:space-y-3">
              <p className="text-sm sm:text-base text-gray-400">
                📧 info@baraemalnoor.com
              </p>
              <p className="text-sm sm:text-base text-gray-400">
                📞 +966-50-123-4567
              </p>
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-8 sm:pt-12">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-sm sm:text-base text-gray-400 text-center sm:text-left">
              © 2024 Baraem Al-Noor. All rights reserved.
            </p>
